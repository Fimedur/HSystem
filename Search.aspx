                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="txt">
                            ...
                            <asp:ListItem>PetFish</asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr>
                            ...
                            <asp:View ID="View1" runat="server">
                                <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sname" HeaderText="Area" />
                                        <asp:BoundField DataField="rent" HeaderText="Price" />
                            ...
                            <asp:View ID="View2" runat="server">
                                <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="blockno" HeaderText="Block" />
                                        <asp:BoundField DataField="sname" HeaderText="Area" />
                                        <asp:BoundField DataField="sell" HeaderText="Price" />
                                        <asp:TemplateField HeaderText="View">
                                            <ItemTemplate>
