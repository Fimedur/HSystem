...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="tbl">
        <tr>
            <td class="tblhead">
                Welcome to Fisheries Information Management System
</td>
        </tr>
        <tr>
            <td>
                                ...
                                <tr>
                                    <td class="style6">
                                        <asp:Button ID="btnrent" runat="server" CssClass="btn" onclick="btnrent_Click" 
                                            Text="SELL NOW" Width="150px" CausesValidation="False" />
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td class="style6">
                                        <asp:Button ID="btnrentnow" runat="server" CssClass="btn" 
                                            onclick="btnrentnow_Click" Text="Sell" Visible="False" Width="90px" />
                                    </td>
                                    <td>
