                ...
                <table align="center" class="style1">
                    ...
                    <tr>
                        <td>
                            &nbsp;</td>
                        <td style="text-align: left">
                            <asp:Button ID="btnadd" runat="server" CssClass="btn" Text="ADD Area" 
                    ...
                    <tr>
                        <td align="center">
                            <asp:GridView ID="GridView1" runat="server" BackColor="White" 
                                ...
                                <asp:BoundField HeaderText="AreaName" DataField="sname" />
                                <asp:BoundField HeaderText="Address" DataField="address" />
                                <asp:BoundField HeaderText="city" DataField="city" />
                                <asp:BoundField HeaderText="Picode" DataField="pincode" />
                                <asp:BoundField HeaderText="Fisheries" DataField="nohouse" />
                                </Columns>
                            </asp:GridView>
                        </td>
                    </tr>
